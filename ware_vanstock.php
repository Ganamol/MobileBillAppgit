...
if(isset($_POST['submit']))
{
  ...
  mysqli_query($con,"INSERT INTO `van_stock`(`product_id`, `Van_id`, `Quantity`, `Date`) VALUES ('$pid','$vanid','$quan','$date')");
  
  mysqli_query($con,"UPDATE `stock_tb` SET `stock`=stock-'$quan' WHERE Product_id='$pid'");
